...
const PRIVATE_KEY = 'APrivateKey1zkpH2Db4GzToLTk8cgDvVUe6FiAcQ8wPhsqstdgXkAtDX2h';
const VIEW_KEY = 'APrivateKey1zkpH2Db4GzToLTk8cgDvVUe6FiAcQ8wPhsqstdgXkAtDX2h';
const APP_NAME = 'token';
const CONTRACT_PATH = 'artifacts/leo/token';
const FEE = '0.01';

export async function mint_public(r0: string, r1: BigInt)  {
